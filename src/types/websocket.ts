export interface EltakoInfoData {
    version: string;
    connected: boolean;
    current_address: string;
    project: EltakoProjectInfo | null;
  }

  export interface EltakoProjectInfo {
    name: string;
    last_modified: string;
    tool_version: string;
    eltako_project_version: string;
  }
...
export interface TelegramDict {
  ...
  export interface EltakoProjectResponse {
    project_loaded: boolean;
    eltako_project: EltakoProject;
  }

  export interface EltakoProject {
    info: EltakoProjectInfo;
